...
<head>
  ...
  <title>Tallers - BCN Cooking Experience</title>
...
<body>
  ...
  <!-- <header class="text-white text-center">
    <div class="header-info">
      <div class="informational-text text-left">
        <h1>Tallers de cuina autèntica</h1>
        <p class="pt-5 descripcion-header">
          En la nostra empresa oferim la calor de la cuina casolana. <br>
          Sempre es troba a faltar el sabor de l'àvia <br>
          i aquí estem perquè l'aprenguis tu!
        </p>
      </div>
  ...
  <div class="text-white text-center">
    <div class="talleres-info">
      <div class="informational-text text-left">
        <h5 class="primer-titulo-IT">Tallers de cuina autèntica.</h5>
        <h6 class="primer-titulo-IT">Gaudeix com mai la cuina tradicional.</h6>
        <div class="fl" id="informational-text-paragrafos">
          <h6 class="pt-5">
            A BCN Cooking Experience sabem que no és el mateix seguir una recepta que cuinar. Per això, els nostres
            tallers són totalment participatius, i en ells els assistents tallen, toquen, fan olor i cuinen amb l'ajuda
            i direcció d'un xef professional.
          </h6>
          <h6 class="pt-5 px-5 descripcion-taller">
            Aprèn a fer 3 plats per a millorar les teves habilitats en la cuina i poder sorprendre els teus amics,
            família o convidats! Els nostres tallers de tapes, guisats i paelles són ideals per a saber més de la cuina
            casolana tradicional.</h6>
        ...
        <div class="fl" id="informational-text-paragrafos-menosw">
          <h6 class="pt-5 pr-5">
            ...
            Por eso, nuestros talleres son totalmente participativos, y en ellos los asistentes cortan, tocan, huelen y
            cocinan con la ayuda y dirección de un chef profesional.
          </h6>
          <h6 class="pt-5 pr-5 descripcion-taller">
            ¡Aprende a hacer 3 platos para mejorar tus habilidades en la cocina y poder sorprender a tus amigos, familia
            o invitados! Nuestros talleres de tapas, guisos y paellas son ideales para saber más de la cocina casera
            tradicional. ¡Al finalizar el taller, se degustarán los platos con una copa de vino o cava a elección!</h6>
          <div class="fl pt-5" id="caracteristicas-taller-div-es">
            ...
            <p class="caracteristicas-taller">
              <span class="precio" id="precio-talleres-es">58€</span>
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="fl mobile-second">
        ...
        <div class="talleres-info">
          <div class="informational-text text-left">
            ...
            <div class="fl w-75" id="texto-talleres-info">
              <h6 class="pt-5 pr-5">
                A BCN Cooking Experience sabem que no és el mateix seguir una recepta que cuinar. Per això, els nostres
                tallers són totalment participatius, i en ells els assistents tallen, toquen, fan olor i cuinen amb
                l'ajuda
                i direcció d'un xef professional.
              </h6>
              <h6 class="pt-5 pr-5 descripcion-taller">
                Aprèn a fer 3 plats per a millorar les teves habilitats en la cuina i poder sorprendre els teus amics,
                família o convidats! Els nostres tallers de tapes, guisats i paelles són ideals per a saber més de la
                cuina
                casolana tradicional.</h6>
              <p class="pt-5 pr-5 caracteristicas-taller">
                Durada: 3h
    ...
    <div class="fotoGrande fl">
      <img src="../img/zanahorias.jpg" alt="Pastanagues">
    </div>
  </div>
  <div class="mobile-first px-4">
    <h1 class="mb-5">Tallers de cuina autèntica</h1>
    <h4 class="mb-5">
      En la nostra empresa oferim la calor de la cuina casolana.
      Sempre es troba a faltar el sabor de l'àvia
      i aquí estem perquè l'aprenguis tu!
    </h4>
    <div class="mb-5">
      <h5>Tallers de cuina autèntica.</h5>
      <h6>Gaudeix com mai la cuina tradicional.</h6>
    </div>
    <h6 class="mb-5">
      A BCN Cooking Experience sabem que no és el mateix seguir una recepta que cuinar. Per això, els nostres
      tallers són totalment participatius, i en ells els assistents tallen, toquen, fan olor i cuinen amb
      l'ajuda i direcció d'un xef professional.
    </h6>
    <h6 class="mb-5">
      Aprèn a fer 3 plats per a millorar les teves habilitats en la cuina i poder sorprendre els teus amics,
      família o convidats! Els nostres tallers de tapes, guisats i paelles són ideals per a saber més de la
      cuina casolana tradicional.
    </h6>
    <div class="mb-5">
      <p class="">
        Durada: 3h
