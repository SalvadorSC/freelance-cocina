...
<head>
  ...
  <title>Guisats - BCN Cooking Experience</title>
...
<body>
    ...
    <header class="text-white text-center">
      <div class="header-info">
        <div class="informational-text text-left">
          <h1 class="pt-2">Guisats tradicionals</br></h1>
          <p class="pt-3 pr-5 descripcion-header">
            Un bon guisat casolà és el millor remei per al fred! <br>
            Aprèn a cuinar 3 tipus de guisat diferent i degusta'ls
            al costat dels teus companys de taller. </p>
        </div>
        <div class="foto-header-w foto-header">
          <img src="../img/garbanzosconbacalao2.PNG" alt="Cigrons amb bacallà">
        </div>
      </div>
    </header>
    <div class="text-white text-center">
      <div class="talleres-info">
        <div class="informational-text text-left pt-5">
          <h5 class="pt-3">Tallers de cuina tradicional.</h5>
          <h6>Gaudeix de la cuina casolana com mai.</h6>
          <div class="fl w-100" id="texto-talleres-info">
            <h6 class="pt-5"> Els guisats tradicionals són els millors,<br>
              per això a BCN Cooking Experience sabem<br>
              que és obligatori ensenyar-te a cuinar-los bé. <br>
              En aquest taller aprendràs 3 plats.</h6>
          </div>
        </div>
  ...
  <div class="mobile-first px-4">
    <h1 class="mb-5">Guisats tradicionals</h1>
    <h4 class="mb-5">
      Un bon guisat casolà és el millor remei per al fred!
      Aprèn a cuinar 3 tipus de guisat diferent i degusta'ls
      al costat dels teus companys de taller.
    </h4>
    <div class="mb-5">
      <h5>Tallers de cuina tradicional.</h5>
      <h6>Gaudeix de la cuina casolana com mai.</h6>
    </div>
    <h6 class="mb-5">
      Els guisats tradicionals són els millors, per això a BCN Cooking Experience sabem
      que és obligatori ensenyar-te a cuinar-los bé. En aquest taller aprendràs 3 plats.
    </h6>
    <div class="mb-5">
      <p class="">
        Durada: 3h
  ...
  <div class="fl mobile-second">
    <div>
      <header class="text-white text-center">
        <div class="header-info">
          <div class="informational-text text-left">
            <h1>Guisats tradicionals</h1>
            <h5 class="pb-5 pt-3 pr-5 descripcion-header">
              Un bon guisat casolà és el millor remei per al fred!
              <br> Aprèn a cuinar 3 tipus de guisat diferent i <br> degusta'ls al costat dels teus companys de taller.
        ...
        <div class="talleres-info mb-5">
          <div class="informational-text text-left mb-5">
            ...
            <div class="fl pb-5" id="informational-text-paragrafos">
              <h6 class="pt-5 pr-5">
                Els guisats tradicionals són els millors,
                per això a BCN Cooking Experience sabem
                que és obligatori ensenyar-te a cuinar-los bé.
                En aquest taller aprendràs 3 plats.
              </h6>
