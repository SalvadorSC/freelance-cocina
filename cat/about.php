...
<body>
  ...
  <div class="pb-5" style="padding-top: 120px">
    <div class="container pb-5">
      <h1 class="mb-5">Qui som:</h1>
      <p class="mb-5">
        Benvingut a BCN Cooking Experience, en el nostre espai de cuina es pot aprendre, gaudir, compartir i viure una
        experiència inoblidable. La nostra passió per l'essència dels valors de la cuina tradicional, recuperant els
        gustos de la terra, juntament amb la més alta qualitat dels nostres productes nadius, mostra en els nostres
        cursos l'autenticitat de la cuina tradicional, la dels nostres avantpassats.

        No dubteu a conèixer els nostres cursos que no els deixaran indiferents, en els quals poden gaudir i participar
        en una bona cuina i coneixeran de primera mà tota la història dels productes que s'utilitzen en un ambient super
        càlid.

        La nostra filosofia és i sempre serà oferir la màxima dedicació i passió per la cuina, transmetent clarament
        tots els detalls en els nostres cursos, de manera que els nostres clients estiguin sempre satisfets.
      </p>
