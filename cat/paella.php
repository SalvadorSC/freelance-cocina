...
<body>
  ...
  <!--     <header class="text-white text-center">
    <div class="header-info">
      <div class="informational-text text-left">
        <h1>Arrossos tradicionals</h1>
        <p class="pt-5 descripcion-header">
          En aquest taller aprendràs a cuinar l'arròs <br>
          que tots voldran menjar! Amb els millors ingredients, <br>
          aconseguirem el sabor tradicional espanyol.
      </div>
  ...
  <div class="text-white text-center">
    <div class="talleres-info">
      <div class="informational-text text-left">
        ...
        <div class="fl w-75">
          <h6 class="pt-5">
            Aprèn a cuinar arrossos amb diferents tipus de gra i tècniques de cocció mitjançant tres receptes per a
            sibarites</h6>
            <p class="pt-5 pr-5">
              Diumenge de 12 a 15h <br>
              -Paella tradicional<br>
              -Arròs negre<br>
              -Fideuá<br>
            </p>
  ...
  <div class="fl mobile-second">
        ...
        <div class="header-info">
          <div class="informational-text text-left">
            ...
            <h4 class="pb-5 pt-3 pr-5 descripcion-header">
              En aquest taller aprendràs a cuinar l'arròs <br>
              que tots voldran menjar! Amb els millors ingredients, <br>
              aconseguirem el sabor tradicional. </h4>
          </div>
        </div>
      </header>
      <div class="text-white text-center">
        <div class="pt-5 talleres-info">
          <div class="pt-5 informational-text text-left">
            ...
            <div class="fl w-75" id="texto-talleres-info">
              ...
              <!-- <p class="pt-1 pr-5 caracteristicas-taller">
                <br><span class="precio">58€</span>
              </p> -->
            </div>
          </div>
    ...
    <div class="fotoGrande fl">
      <img src="../img/arroz-vertical.jpg" alt="Arrós tradicional acompanyat amb pà">
    </div>
  </div>

  <div class="mobile-first px-4">
    <h1 class="mb-5">Arrossos tradicionals</h1>
    <h4 class="mb-5">
      En aquest taller aprendràs a cuinar l'arròs
      que tots voldran menjar! Amb els millors ingredients,
      aconseguirem el sabor tradicional espanyol.
    </h4>
    <div class="mb-5">
      <h5>Tallers de cuina tradicional.</h5>
