...
<head>
  ...
  <title>Guisos - BCN Cooking Experience</title>
      ...
      <header class="text-white text-center">
        <div class="header-info">
          <div class="informational-text text-left">
            <h1>Guisos tradicionales</h1>
            <h5 class="pb-5 pt-3 pr-5 descripcion-header">
              ¡Un buen guiso casero es el mejor remedio para el frío!
              Aprende a cocinar 3 tipos de guiso distinto y degústalos
              junto a tus compañeros de taller.
            </h5>
          </div>
        </div>
      </header>
        ...
        <div class="talleres-info mb-5">
          <div class="informational-text text-left mb-5">
            ...
            <div class="fl pb-5" id="informational-text-paragrafos">
              <h5 class="pt-5 pr-5">
                Los guisos tradicionales son los mejores,
                por eso en BCN Cooking Experience sabemos
                que es obligatorio enseñarte a cocinarlos bien.
                En este taller aprenderás 3 platos.
              </h5>
            ...
            <div class="fl" id="informational-text-paragrafos-menosw">
              ...
              <h5 class=" pr-5">
                Con estas tapas podrás degustar lo mejor de ir a un bar, el sabor de siempre.
              </h5>
