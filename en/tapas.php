...
<head>
  ...
  <title>Tapas - BCN Cooking Experience</title>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <select class="bg-light language-selector" onchange="if (this.value) window.location.href=this.value">
            ...
            <option value="/cat/tapas.php">CAT</option>
      ...
      <header class="text-white text-center">
        <div class="header-info">
          <div class="informational-text text-left">
            <h1>Traditional Tapas</h1>
            <h4 class="pb-5 pt-3 pr-5 descripcion-header">
              If you are a tapas gourmet, this workshop is for you!</h4>
          </div>
        </div>
      </header>
      <div class="text-white text-center">
        <div class="talleres-info mb-5">
          <div class="informational-text text-left mb-5">
            <h5>Traditional tapas cooking workshops</h5>
            <h6>Enjoy Spanish cuisine like never before.</h6>
            <div class="fl pb-5" id="informational-text-paragrafos">
              <h6 class="pt-5">
                With these tapas you will be able to taste the best of going to a bar in Spain, with the
                same
                flavor as always.
              </h6>
              <!-- <p class="pt-5 px-5">
                Thursday from 18h to 21h <br>
                -Homemade meatballs<br>
                -Fried squid rings <br>
                -Potato tortilla <br>
              </p>
              <p class="pt-5 px-5 pb-3">
                Friday from 18h to 21h<br>
                -Spicy calluses <br>
                -Octopus in sauce<br>
                -Fried squid rings<br>
              </p> -->
    ...
    <header class="text-white text-center">
      <div class="header-info">
        ...
        <div class="foto-header-w foto-header">
          <img src="../img/pizza.jpg" alt="Traditional Pizza">
        </div>
      </div>
    </header>
    ...
    <div class="text-white text-center">
      <div class="talleres-info">
        <div class="informational-text text-left">
          ...
          <div class="fl w-100">
            <h6 class="pt-5 pr-5">
              With these tapas you will be able to taste the best <br> of going to a bar in Spain, with the
              same
              flavor as always.
            </h6>
        ...
        <div class="foto-header foto-header-w">
          <img src="../img/niscalos.jpg" alt="Mushrooms">
        </div>
      </div>
    </div>
  </div> -->
  <div class="mobile-first px-4">
    <h1 class="mb-5">Traditional Tapas</h1>
    <h4 class="mb-5">
      If you are a tapas gourmet, this workshop is for you!<br>
    </h4>
    <div class="mb-5">
      <h5>Traditional tapas cooking workshops</h5>
      <h6>Enjoy authentic cuisine like never before.</h6>
    ...
    <h6 class="mb-5">
      With these tapas you will be able to taste the best of going to a bar in Spain, with the same flavor as always.
    </h6>
    <!-- <p class="">
      Thursday from 18h to 21h <br>
      -Homemade meatballs<br>
      ...
      <div class="row">
        ...
        <div class="mx-auto carta mb-5">
          <div class="features-icons-item mx-auto">
            ...
            <p class="lead text-justify mb-2 mx-3">Discover traditional Catalan cuisine with these three famous
              dishes.
            </p>
