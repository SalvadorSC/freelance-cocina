...
<head>
  ...
  <title>Paella - BCN Cooking Experience</title>
  ...
  <!--   <link href="../css/paella.css" rel="stylesheet"> -->
...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <select class="bg-light language-selector" onchange="if (this.value) window.location.href=this.value">
            <option value="/en/paella.php" id="en">EN</option>
            <option value="/cat/paella.php" id="ca">CAT</option>
            <option value="/paella.php" id="es">ESP</option>
          </select>
        </ul>
      </div>
    </div>
    ...
    <div class="header-info">
      <div class="informational-text text-left">
        ...
        <p class="pt-5 descripcion-header">
          In this workshop you will learn how to cook rice <br>that everyone will want to eat! With the best
          ingredients, <br>we will get the traditional Spanish flavor.
      </div>
  ...
  <div class="text-white text-center">
    <div class="talleres-info">
      <div class="informational-text text-left">
        ...
        <div class="fl w-75">
          <h6 class="pt-5">
            Learn to cook rice with different types of grain and cooking techniques through three recipes for
            foodies </h6>
          <p class="pt-5 pr-5">
            Sunday from 12 to 15h <br>
            -Traditional Paella<br>
            -Black rice<br>
            -Fideuá<br>
          </p>
          <p class="pt-5 pl-5 caracteristicas-taller">
  ...
  <div class="fl mobile-second">
        ...
        <div class="header-info">
          <div class="informational-text text-left">
            ...
            <h4 class="pb-5 pt-3 pr-5 descripcion-header">
              In this workshop you will learn how to cook rice <br>that everyone will want to eat! With the best
              ingredients, <br>we will get the traditional flavor. </h4>
          </div>
        </div>
      </header>
      <div class="text-white text-center">
        <div class="pt-5 talleres-info">
          <div class="pt-5 informational-text text-left">
            <h5>Traditional cooking workshops.</h5>
            <h6>Enjoy authenthic cuisine like never before.</h6>
            <div class="fl w-75" id="texto-talleres-info">
              ...
              <!-- <p class="pb-5 pr-5 caracteristicas-taller">
                <br><span class="precio pr-5">58€</span>
              </p> -->
            </div>
          </div>
        </div>
    ...
    <div class="fotoGrande fl">
      <img src="../img/arroz-vertical.jpg" alt="Paella accompanied with bread">
    </div>
  </div>
  <div class="mobile-first px-4">
    <h1 class="mb-5">Traditional rice dishes</h1>
    <h4 class="mb-5">
      In this workshop you will learn how to cook rice that everyone will want to eat! With the best
      ingredients, we will get the traditional Spanish flavor.
    </h4>
    <div class="mb-5">
      <h5>Traditional cooking workshops.</h5>
      <h6>Enjoy authenthic cuisine like never before.</h6>
      ...
      <div class="row">
        <div class="mx-auto carta mb-5">
          <div class="features-icons-item mx-auto mb-3 ">
            <img src="../img/pulpo-2.PNG" class="img-fluid carta-tapas mx-0 img-border-20" alt="Octupus">
